        ...
        <div className="flex min-w-0 flex-1 flex-col gap-3 bg-[var(--ge-page)] p-0 sm:gap-4 md:min-h-0 md:overflow-hidden">
          ...
          <div className="w-full max-w-full overflow-x-auto rounded-[var(--ge-radius-xl)] border border-[var(--ge-border)] bg-[var(--ge-card)] md:flex md:min-h-0 md:flex-1 md:flex-col">
            {headers.length === 0 ? (
              ...
              <div 
                ref={parentRef}
                className="ge-table-scroll max-h-[70vh] md:relative overflow-auto"
              >
                <table
                    ...
                    {virtualRows.map((virtualRow) => {
                      ...
                      return (
                        ...
                        >
                          <td
                            className={cn(
                              "ge-col-rule xl:sticky z-[1] bg-[var(--ge-card)] px-3 py-2.5 align-top font-mono text-[12px] tabular-nums text-[var(--ge-text-muted)] group-hover:bg-[var(--ge-panel)]",
                              edge
                            )}
                          ...
                          <td
                            className="ge-col-rule xl:sticky z-[1] overflow-visible bg-[var(--ge-card)] px-3 py-2.5 align-top group-hover:bg-[var(--ge-panel)]"
                          ...
                          <td
                            className="ge-col-rule xl:sticky z-[1] bg-[var(--ge-card)] px-3 py-2.5 align-top group-hover:bg-[var(--ge-panel)]"
                            style={{
